    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MenuData = table.Column<byte[]>(type: "longblob", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_companyhours", x => x.Id);
                    table.ForeignKey(
                        name: "FK_companyhours_companies_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_companyhours_CompanyId_DayOfWeek",
                table: "companyhours",
