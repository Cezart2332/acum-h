    ...
    try {
      ...
      if (storedCompany) {
        ...
        if (response.success && response.data) {
          ...
          // Update stored data
          await AsyncStorage.setItem("company", JSON.stringify(freshCompanyData));
        }
      } else {
        ...
        <View style={{ padding: 20 }}>
          {loading ? (
            ...
            <View style={{ flex: 1, justifyContent: "center", alignItems: "center", paddingTop: 100 }}>
              ...
              <Text style={{ color: "#EF4444", marginTop: 16, fontSize: 18, fontWeight: "600", textAlign: "center" }}>
                {error}
              </Text>
              <TouchableOpacity
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                <View style={{ alignItems: "center", marginBottom: 20 }}>
                  ...
                  >
                    Contul tău este în curs de verificare de către echipa noastră. Vei primi o notificare când contul va fi activat.
                  </Text>
                </View>
                ...
                >
                  ...
                  <Text style={{ color: "#E5E5E5", fontSize: 14, lineHeight: 20 }}>
