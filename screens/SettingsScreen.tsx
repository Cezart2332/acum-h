...
export type RootStackParamList = { Login: undefined; Register: undefined; Home: undefined; Profile: undefined; };
type HomeNav = NativeStackNavigationProp<RootStackParamList, 'Home'>;

export default function SettingsScreen({ navigation }: { navigation: HomeNav }) {
  ...
  const onEditProfile = () => navigation.navigate('Profile');
  const onChangePassword = () => Alert.alert('Change Password', 'Redirect to change password screen');
  const onAbout = () => Alert.alert('About', 'App version: 1.0.0');
