...
async function testApiConnectivity() {
  ...
  try {
    ...
    console.log(
      "   Events:",
      Array.isArray(events) ? events.length : "Not an array",
      "items"
    );
    ...
    console.log(
      "   Locations:",
      Array.isArray(locations) ? locations.length : "Not an array",
      "items"
    );

    console.log("\n   📅 Getting reservations...");
    const reservations =
      (await ApiServiceWithFallback.getReservations()) as any[];
    console.log(
      "   Reservations:",
      Array.isArray(reservations) ? reservations.length : "Not an array",
      "items"
    );
